...
- **Codex analyzes, Codex reviews**: Codex reads proof, formulates questions, implements fixes. Codex provides adversarial review.
...
```json
{
  ...
  "trace_path":       ".vibe/traces/proof-checker/<date>_run<NN>/",
