...
### Phase 6: External Review via reviewer_client.py

Send the poster content plan + key LaTeX sections to the external reviewer for review.
...
## ⛔ Output Verification (must run before ending)
