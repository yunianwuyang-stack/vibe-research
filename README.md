...
[![Version](https://img.shields.io/badge/version-1.2.2-blue.svg)](https://github.com/your-repo/vibe-research/releases)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-Windows-lightgrey.svg)](https://github.com/your-repo/vibe-research)
...
| 项目 | 贡献方向 |
|---|---|
| [Auto-claude-code-research-in-sleep](https://github.com/your-ref/auto-claude-code-research-in-sleep) | 无人值守 Claude Code CLI 自主研究执行模式、任务封装与 checkpoint 机制 |
| [ruflo](https://github.com/your-ref/ruflo) | 工作流编排引擎设计、Skill 运行器与技能包管理机制 |
| [local-deep-research](https://github.com/your-ref/local-deep-research) | 本地离线深度文献检索、多数据源聚合与系统综述协议 |
| [Rethlas](https://github.com/your-ref/rethlas) | 学术文档生成、LaTeX/DOCX 工具链集成与写作规则体系 |
...
|---|---|
| [Auto-claude-code-research-in-sleep](https://github.com/your-ref/auto-claude-code-research-in-sleep) | Unattended Claude Code CLI autonomous research execution model, task encapsulation & checkpoint mechanism |
| [ruflo](https://github.com/your-ref/ruflo) | Workflow orchestration engine design, skill runner & skill pack management |
| [local-deep-research](https://github.com/your-ref/local-deep-research) | Local offline deep literature search, multi-source aggregation & systematic review protocol |
| [Rethlas](https://github.com/your-ref/rethlas) | Academic document generation, LaTeX/DOCX toolchain integration & writing rules framework |

> 💡 Please replace the placeholder links above with the actual GitHub URLs before publishing.
